...
# The upstream test helpers live in git/t/t5801/
# Add to PATH so testgit:: protocol works
REMOTE_HELPER_DIR="$TEST_DIRECTORY/../git/t/t5801"
if test -d "$REMOTE_HELPER_DIR"; then
	PATH="$REMOTE_HELPER_DIR:$PATH"
	export PATH
fi
