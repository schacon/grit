//! `gust tag` — create, list, delete, and manage tags.
//!
...
use gust_lib::objects::{parse_commit, parse_tag, serialize_tag, ObjectId, ObjectKind, TagData};
use gust_lib::repo::Repository;
use gust_lib::rev_parse::resolve_revision;
use gust_lib::state::resolve_head;
use std::fs;
use std::io::{self, Write};
use std::path::Path;
use time::OffsetDateTime;

/// Arguments for `gust tag`.
