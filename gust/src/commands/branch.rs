//! `gust branch` — list, create, or delete branches.

use anyhow::{bail, Context, Result};
use clap::Args as ClapArgs;
use gust_lib::objects::{parse_commit, ObjectId};
...
fn commit_subject(odb: &gust_lib::odb::Odb, oid: &ObjectId) -> Option<String> {
