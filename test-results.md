...
- `./scripts/run-tests.sh t3311-notes-merge-fanout.sh`: 24/24 passing (notes merge with fanout trees, merge strategies, manual conflict + `NOTES_MERGE_WORKTREE`; harness CSV/dashboards refreshed).
